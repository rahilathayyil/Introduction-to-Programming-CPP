...
bool questioner(string question, string answer)
{
  string userAnswer = "";
...
int main()
{
  ...
  cout << " - - - - - - - - - - - - - - - - - - - - - - - - - - - - - -\n\n" << endl;
    ...
    if (questioner(question0, answer0)) score++;
    if (questioner(question1, answer1)) score++;
    if (questioner(question2, answer2)) score++;
